...
//! `Control::with_core`. The thin `Control` wrapper methods have been removed in Task 5
//! of the shared-node-seam refactor; `node.rs` now calls `flowplane_node::add_fw_rule` /
