...
type PortStatusApplyConfiguration struct {
	...
	Type *compiledv1alpha1.PortType `json:"type,omitempty"`
...
func (b *PortStatusApplyConfiguration) WithType(value compiledv1alpha1.PortType) *PortStatusApplyConfiguration {
	b.Type = &value
	return b
}
