...
import (
	...
	"github.com/trevex/ectobase/api/compiled/fuzzer"
)

// TestRoundTripTypes exercises the generated internal<->versioned conversions
// (api/compiled/v1alpha1/zz_generated.conversion.go) via the standard apimachinery
...
// internal (api/compiled) and versioned (api/compiled/v1alpha1) shapes.
