...
import (
	...
	"github.com/trevex/ectobase/api/storage/fuzzer"
)

// TestRoundTripTypes exercises the generated internal<->versioned conversions
// (api/storage/v1alpha1/zz_generated.conversion.go) via the standard apimachinery
...
// internal (api/storage) and versioned (api/storage/v1alpha1) shapes.
