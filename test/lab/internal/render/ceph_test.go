...
const cephFixture = `
name: ectobase
images: {talos: img/talos, tayga: img/tayga, wan: img/wan, registry: registry:2, frr: img/frr, ceph: img/ceph, vyos: img/vyos, flowplane: img/flowplane}
fabric:
...
name: ectobase
images: {talos: img/talos, tayga: img/tayga, wan: img/wan, registry: registry:2, vyos: img/vyos, flowplane: img/flowplane}
fabric:
  as: {edge: 65000, switch: 65010, host: 65100}
  nat64Prefix: 64:ff9b::/96
  clusters: [{name: dispatch, nodes: 1}, {name: k02, nodes: 2}]
