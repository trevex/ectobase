...
// RBAC for the dispatch controller (clusterpool + scheduler + failover/fence).
// Rules generated into charts/ectobase-dispatch/files/dispatch-controller/role.yaml.
