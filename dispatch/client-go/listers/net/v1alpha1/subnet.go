...
type SubnetLister interface {
	...
	List(selector labels.Selector) (ret []*netv1alpha1.Subnet, err error)
...
type subnetLister struct {
	listers.ResourceIndexer[*netv1alpha1.Subnet]
}

// NewSubnetLister returns a new SubnetLister.
func NewSubnetLister(indexer cache.Indexer) SubnetLister {
	return &subnetLister{listers.New[*netv1alpha1.Subnet](indexer, netv1alpha1.Resource("subnet"))}
}

// Subnets returns an object that can list and get Subnets.
func (s *subnetLister) Subnets(namespace string) SubnetNamespaceLister {
	return subnetNamespaceLister{listers.NewNamespaced[*netv1alpha1.Subnet](s.ResourceIndexer, namespace)}
}
...
type SubnetNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*netv1alpha1.Subnet, error)
