...
// ComputeV1alpha1Client is used to interact with features provided by the compute.ectobase.dev group.
type ComputeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ComputeV1alpha1Client) Containers(namespace string) ContainerInterface {
