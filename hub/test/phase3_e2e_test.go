...
func TestPhase3_HeartbeatScheduleCompileSync_E2E(t *testing.T) {
	...
	if err := hubClient.Get(ctx, client.ObjectKey{Name: "c1"}, got); err != nil {
	...
	// ================================================================
	cr := &controllers.CompiledNICReconciler{Client: hubClient, DefaultClusterName: "default"}
	...
	if err := hubClient.Get(ctx, client.ObjectKey{Namespace: ns, Name: "default-nic-a"}, compiled); err != nil {
