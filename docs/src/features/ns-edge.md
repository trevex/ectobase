...
See the [clab + kind fabric](../ops/clab-fabric.md) for the VyOS edge topology this runs on, and
the [runbook](../ops/runbook.md) for the edge dual-XDP-attach pinning caveat in SKB mode.
