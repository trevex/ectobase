...
[`flowplane-core`](../dataplane/pure-core.md) (`encap::write_outer_v6`,
...
See [Datapath programs](../dataplane/programs.md) for the full per-program breakdown,
...
- [Datapath programs](../dataplane/programs.md) — the programs that implement encap/decap.
- [BPF maps & state model](../dataplane/maps.md) — `ROUTES`, `UNDERLAY`, `INTERFACES`, …
